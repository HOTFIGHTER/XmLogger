...
BOOST_FUNCTION_FUNCTION(
Functor BOOST_FUNCTION_TARGET_FIX(const &
) f
...
return get_vtable()->invoker
    (this->
functor BOOST_FUNCTION_COMMA BOOST_FUNCTION_ARGS
);
}
...
BOOST_FUNCTION_FUNCTION&
#endif
operator=(Functor BOOST_FUNCTION_TARGET_FIX(const &)
f)
{
this->
clear();
...
template<typename Functor, typename Allocator>
void assign(Functor BOOST_FUNCTION_TARGET_FIX(const &)
f,
Allocator a
)
{
...
BOOST_FUNCTION_FUNCTION&
operator=(BOOST_FUNCTION_FUNCTION
&& f)
{
...
private:
void assign_to_own(const BOOST_FUNCTION_FUNCTION &
f)
{
if (!f.
empty()
...
// Move constructors
function(self_type
&& f): base_type(static_cast<base_type&&>(f)){
}
function(base_type
&& f): base_type(static_cast<base_type&&>(f)){
}
