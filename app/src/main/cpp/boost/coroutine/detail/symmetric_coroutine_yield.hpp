...
class symmetric_coroutine_yield {
 private:
  ...
  friend
  class symmetric_coroutine_object;
  ...
  symmetric_coroutine_yield(impl_type *impl, R *result)
  BOOST_NOEXCEPT :
  impl_(impl),
  result_(result) {
 ...
 public:
  ...
  symmetric_coroutine_yield ( BOOST_RV_REF(symmetric_coroutine_yield)
  other)
  BOOST_NOEXCEPT :
      impl_(0),
      result_(
  ...
  symmetric_coroutine_yield &operator=(BOOST_RV_REF(symmetric_coroutine_yield) other)
  BOOST_NOEXCEPT
  {
  ...
  void swap(symmetric_coroutine_yield &other)
  BOOST_NOEXCEPT
  {
...
class symmetric_coroutine_yield<R &> {
 ...
 public:
  ...
  symmetric_coroutine_yield(BOOST_RV_REF(symmetric_coroutine_yield) other)
  BOOST_NOEXCEPT :
      impl_(0),
      result_(
  0)
...
class symmetric_coroutine_yield<void> {
 private:
  ...
  symmetric_coroutine_yield(impl_type *impl)
  BOOST_NOEXCEPT :
  impl_(impl) { BOOST_ASSERT(0 != impl_); }
 ...
 public:
  ...
  inline void swap(symmetric_coroutine_yield &other)
  BOOST_NOEXCEPT
  { std::swap(impl_, other.impl_); }
...
template<typename R>
void swap(symmetric_coroutine_yield<R> &l, symmetric_coroutine_yield<R> &r) { l.swap(r); }
