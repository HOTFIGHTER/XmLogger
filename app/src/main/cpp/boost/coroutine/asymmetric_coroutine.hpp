...
# endif
  ...
  push_coroutine(BOOST_RV_REF(push_coroutine) other)
  BOOST_NOEXCEPT :
  impl_(0) { swap(other); }

  push_coroutine &operator=(BOOST_RV_REF(push_coroutine) other)
  BOOST_NOEXCEPT
  {
  ...
  class iterator: public std::iterator<std::output_iterator_tag, void, void, void, void> {
   ...
   public:
    ...
    bool operator==(iterator const &other) const { return other.c_ == c_; }
...
# endif
  ...
  inline push_coroutine(BOOST_RV_REF(push_coroutine) other)
  BOOST_NOEXCEPT :
  impl_(0) { swap(other); }

  inline push_coroutine &operator=(BOOST_RV_REF(push_coroutine) other)
  BOOST_NOEXCEPT
  {
    push_coroutine tmp(mars_boost::move( other));
    swap(tmp);
  ...
  inline void swap(push_coroutine &other)
  BOOST_NOEXCEPT
  { std::swap(impl_, other.impl_); }
...
# endif
  template<typename Fn>
  explicit pull_coroutine ( BOOST_RV_REF(Fn)
  fn,
  attributes const &attrs = attributes()
  ) :
  impl_( 0)
  ...
  pull_coroutine(BOOST_RV_REF(pull_coroutine) other)
  BOOST_NOEXCEPT :
  impl_(0) { swap(other); }

  pull_coroutine &operator=(BOOST_RV_REF(pull_coroutine) other)
  BOOST_NOEXCEPT
  {
  ...
  class iterator: public std::iterator<std::input_iterator_tag,
   ...
   public:
    ...
    bool operator==(iterator const &other) const { return other.c_ == c_ && other.val_ == val_; }
  ...
  class const_iterator: public std::iterator<std::input_iterator_tag,
                                             const typename remove_reference<R>::type> {
   private:
    pull_coroutine<R> *c_;
    R *val_;
...
# endif
  ...
  inline pull_coroutine(BOOST_RV_REF(pull_coroutine) other)
  BOOST_NOEXCEPT :
  impl_(0) { swap(other); }

  inline pull_coroutine &operator=(BOOST_RV_REF(pull_coroutine) other)
  BOOST_NOEXCEPT
  {
    pull_coroutine tmp(mars_boost::move( other));
    swap(tmp);
  ...
  inline void swap(pull_coroutine &other)
  BOOST_NOEXCEPT
  { std::swap(impl_, other.impl_); }
...
template<typename Arg>
template<typename Fn>
push_coroutine<Arg>::push_coroutine ( BOOST_RV_REF(Fn)
fn,
attributes const &attrs
) :
impl_( 0) {
...
template<typename Fn>
push_coroutine<void>::push_coroutine(BOOST_RV_REF(Fn)
fn,
attributes const &attrs
) :
impl_( 0)
...
range_begin(pull_coroutine <R> &c) { return typename pull_coroutine<R>::iterator(&c); }

template<typename R>
typename pull_coroutine<R>::const_iterator
    range_begin(pull_coroutine < R >
const& c)
{ return
typename pull_coroutine<R>::const_iterator( &c);
}

template<typename R>
typename pull_coroutine<R>::iterator
range_end(pull_coroutine <R> &) { return typename pull_coroutine<R>::iterator(); }
...
range_begin(push_coroutine <Arg> &c) { return typename push_coroutine<Arg>::iterator(&c); }

template<typename Arg>
typename push_coroutine<Arg>::iterator
range_end(push_coroutine <Arg> &) { return typename push_coroutine<Arg>::iterator(); }
...
template<typename R>
typename pull_coroutine<R>::iterator
begin(pull_coroutine <R> &c) { return mars_boost::begin(c); }

template<typename R>
typename pull_coroutine<R>::const_iterator
    begin(pull_coroutine < R >
const& c)
{ return
mars_boost::begin( c);
}
...
template<typename R>
typename pull_coroutine<R>::iterator
end(pull_coroutine <R> &c) { return mars_boost::end(c); }

template<typename R>
typename pull_coroutine<R>::const_iterator
    end(pull_coroutine < R >
const& c)
{ return
mars_boost::end( c);
}
...
begin(push_coroutine <R> &c) { return mars_boost::begin(c); }

template<typename R>
typename push_coroutine<R>::iterator
end(push_coroutine <R> &c) { return mars_boost::end(c); }
