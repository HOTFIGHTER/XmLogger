...
template<mars_boost::intmax_t X, mars_boost::intmax_t Y, mars_boost::intmax_t = mpl::sign_c<
    mars_boost::intmax_t,
    Y>::value>
class br_add;
...
class br_add<X, Y, 1> {
  static const mars_boost::intmax_t
      min = mars_boost::integer_traits<mars_boost::intmax_t>::const_min;
  static const mars_boost::intmax_t
      max = mars_boost::integer_traits<mars_boost::intmax_t>::const_max;
...
class br_mul {
  static const mars_boost::intmax_t nan =
      mars_boost::intmax_t(
          BOOST_RATIO_UINTMAX_C(1) << (sizeof(mars_boost::intmax_t) * CHAR_BIT - 1));
  static const mars_boost::intmax_t
      min = mars_boost::integer_traits<mars_boost::intmax_t>::const_min;
  static const mars_boost::intmax_t
      max = mars_boost::integer_traits<mars_boost::intmax_t>::const_max;
...
template<mars_boost::intmax_t X, mars_boost::intmax_t Y>
class br_div {
  static const mars_boost::intmax_t nan = mars_boost::intmax_t(
      BOOST_RATIO_UINTMAX_C(1) << (sizeof(mars_boost::intmax_t) * CHAR_BIT - 1));
  static const mars_boost::intmax_t
      min = mars_boost::integer_traits<mars_boost::intmax_t>::const_min;
  static const mars_boost::intmax_t
...
struct ratio_add {
 ...
 private:
  static const mars_boost::intmax_t
      gcd_n1_n2 = mpl::gcd_c<mars_boost::intmax_t, R1::num, R2::num>::value;
  static const mars_boost::intmax_t
      gcd_d1_d2 = mpl::gcd_c<mars_boost::intmax_t, R1::den, R2::den>::value;
 public:
...
struct ratio_multiply {
 ...
 private:
  static const mars_boost::intmax_t
      gcd_n1_d2 = mpl::gcd_c<mars_boost::intmax_t, R1::num, R2::den>::value;
  static const mars_boost::intmax_t
      gcd_d1_n2 = mpl::gcd_c<mars_boost::intmax_t, R1::den, R2::num>::value;
 public:
