...
struct lcm
    : lcm_impl<
        typename lcm_tag<N1>::type, typename lcm_tag<N2>::type
...
template<typename T1, mars_boost::intmax_t n1, bool n1_is_0, typename T2, mars_boost::intmax_t n2, bool n2_is_0>
struct lcm_aux
