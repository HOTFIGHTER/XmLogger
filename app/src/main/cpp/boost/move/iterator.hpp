...
#endif
  typedef It pointer;
  typedef typename mars_boost::movelib::iterator_traits<iterator_type>::difference_type
      difference_type;
  typedef typename mars_boost::movelib::iterator_traits<iterator_type>::iterator_category
      iterator_category;
