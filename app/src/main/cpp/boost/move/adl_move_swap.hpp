...
struct and_op_impl { static const bool value = false; };

template<class P1, class P2>
struct and_op_impl<P1, P2, true> { static const bool value = P2::value; };
...
template<class P1, class P2, bool = P1::value>
struct and_op_not_impl { static const bool value = false; };

template<class P1, class P2>
struct and_op_not_impl<P1, P2, true> { static const bool value = !P2::value; };
...
void swap_proxy(T &x,
                T &y,
                typename mars_boost::move_detail::enable_if_c<!mars_boost::move_detail::has_move_emulation_enabled_impl<
                    T>::value>::type * = 0) {
...
void swap_proxy(T &x,
                T &y,
                typename mars_boost::move_detail::enable_if<and_op_not_impl<mars_boost::move_detail::has_move_emulation_enabled_impl<
                    T>, mars_boost_move_member_swap::has_member_swap<T> >
                >::type * = 0) {
...
void swap_proxy(T &x,
                T &y,
                typename mars_boost::move_detail::enable_if<and_op_impl<mars_boost::move_detail::has_move_emulation_enabled_impl<
                    T>, mars_boost_move_member_swap::has_member_swap<T> >
                >::type * = 0) { x.swap(y); }
