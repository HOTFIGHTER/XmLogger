...
template<class Fp,
    ...
    class T6 = tuples::null_type, class T7 = tuples::null_type, class T8 = tuples::null_type, class T9 = tuples::null_type
>
class invoker;
...
class invoker<Fp, T0, T1, T2, T3, T4, T5, T6, T7, T8> {
 ...
 public:
  ...
  BOOST_SYMBOL_VISIBLE
  explicit invoker(BOOST_THREAD_FWD_REF(Fp)
                   f,
                   BOOST_THREAD_RV_REF(T0)
                   a0,
                   BOOST_THREAD_RV_REF(T1)
                   a1,
                   BOOST_THREAD_RV_REF(T2)
                   a2,
                   BOOST_THREAD_RV_REF(T3)
                   a3,
                   BOOST_THREAD_RV_REF(T4)
                   a4,
                   BOOST_THREAD_RV_REF(T5)
                   a5,
                   BOOST_THREAD_RV_REF(T6)
                   a6,
                   BOOST_THREAD_RV_REF(T7)
                   a7,
                   BOOST_THREAD_RV_REF(T8)
                   a8
  )
  :
  ...
  :
  fp_ (mars_boost::move(BOOST_THREAD_RV(f)
  .fp))
  ,
  v0_ (mars_boost::move(BOOST_THREAD_RV(f)
  .v0_))
  ,
  v1_ (mars_boost::move(BOOST_THREAD_RV(f)
  .v1_))
  ,
  v2_ (mars_boost::move(BOOST_THREAD_RV(f)
  .v2_))
  ,
  v3_ (mars_boost::move(BOOST_THREAD_RV(f)
  .v3_))
  ,
  v4_ (mars_boost::move(BOOST_THREAD_RV(f)
  .v4_))
  ,
  v5_ (mars_boost::move(BOOST_THREAD_RV(f)
  .v5_))
  ,
  v6_ (mars_boost::move(BOOST_THREAD_RV(f)
  .v6_))
  ,
  v7_ (mars_boost::move(BOOST_THREAD_RV(f)
  .v7_))
  ,
  v8_ (mars_boost::move(BOOST_THREAD_RV(f)
  .v8_))
  {}
...
class invoker<Fp, T0, T1> {
 ...
 public:
  ...
  BOOST_SYMBOL_VISIBLE
  explicit
  invoker(BOOST_THREAD_FWD_REF(Fp) f, BOOST_THREAD_RV_REF(T0) a0, BOOST_THREAD_RV_REF(T1) a1
  )
  :
  fp_ (mars_boost::move(f))
  , v0_(mars_boost::move(a0))
  ...
  result_type operator()() {
    return detail::invoke(mars_boost::move(fp_), mars_boost::move(v0_), mars_boost::move(v1_)
    );
  }
};
...
class invoker<Fp, T0> {
 ...
 public:
  ...
  result_type operator()() {
    return detail::invoke(mars_boost::move(fp_), mars_boost::move(v0_)
    );
  }
};
template<class Fp>
