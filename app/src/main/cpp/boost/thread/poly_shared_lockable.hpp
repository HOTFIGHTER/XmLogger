...
class upgrade_poly_lockable: public shared_poly_lockable {
 public:
  ...
  virtual bool
  try_unlock_shared_and_lock_until(chrono::system_clock::time_point const &abs_time) = 0;
  virtual bool
  try_unlock_shared_and_lock_until(chrono::steady_clock::time_point const &abs_time) = 0;
  template<typename Clock, typename Duration>
  ...
  virtual bool
  try_unlock_shared_and_lock_upgrade_until(chrono::system_clock::time_point const &abs_time) = 0;
  virtual bool
  try_unlock_shared_and_lock_upgrade_until(chrono::steady_clock::time_point const &abs_time) = 0;
  template<typename Clock, typename Duration>
  bool
  try_unlock_shared_and_lock_upgrade_until(chrono::time_point <Clock, Duration> const &abs_time) {
  ...
  virtual bool
  try_unlock_upgrade_and_lock_until(chrono::system_clock::time_point const &abs_time) = 0;
  virtual bool
  try_unlock_upgrade_and_lock_until(chrono::steady_clock::time_point const &abs_time) = 0;
  template<typename Clock, typename Duration>
