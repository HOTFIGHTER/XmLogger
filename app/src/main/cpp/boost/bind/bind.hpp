...
template<int I> bool ref_compare(arg < I >
const &, arg <I> const &, int ) {
return true;
}
...
template<class T> bool ref_compare(reference_wrapper < T >
const & a,
...
template<class T>
bool ref_compare(value<weak_ptr < T>
> const & a, value<weak_ptr < T> > const & b, int )
{
return !(a.
get()
< b.
...
class list0 {
 public:
  ...
  operator[](bind_t<R, F, L> const &b) const { return b.eval(*this); }
...
class list8: private storage8<A1, A2, A3, A4, A5, A6, A7, A8> {
 ...
 public:
  ...
  list8(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8) : base_type(a1,
                                                                            a2,
                                                                            a3,
                                                                            a4,
                                                                            a5,
...
class list9: private storage9<A1, A2, A3, A4, A5, A6, A7, A8, A9> {
 ...
 public:
  ...
  list9(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9) : base_type(a1,
                                                                                   a2,
                                                                                   a3,
                                                                                   a4,
                                                                                   a5,
...
class rrlist1 {
 ...
 public:
  ...
  A1 &&
  operator[](mars_boost::arg<1>) const { return std::forward<A1>(a1_); } // not static_cast because of g++ 4.9
...
typedef typename _bi::list_av_1<A1>::type list_type;
return
_bi::bind_t<result_type, F, list_type>( F(f), list_type(a1)
);
}
