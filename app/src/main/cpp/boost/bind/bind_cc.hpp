...
_bi::bind_t<R,
            BOOST_BIND_ST
            R(BOOST_BIND_CC * )(B1, B2, B3, B4, B5),
...
_bi::bind_t<R,
            BOOST_BIND_ST
            R(BOOST_BIND_CC * )(B1, B2, B3, B4, B5, B6),
...
_bi::bind_t<R,
            BOOST_BIND_ST
            R(BOOST_BIND_CC * )(B1, B2, B3, B4, B5, B6, B7),
...
_bi::bind_t<R,
            BOOST_BIND_ST
            R(BOOST_BIND_CC * )(B1, B2, B3, B4, B5, B6, B7, B8),
...
_bi::bind_t<R,
            BOOST_BIND_ST
            R(BOOST_BIND_CC * )(B1, B2, B3, B4, B5, B6, B7, B8, B9),
            typename _bi::list_av_9<A1, A2, A3, A4, A5, A6, A7, A8, A9>::type>
BOOST_BIND(BOOST_BIND_ST R(BOOST_BIND_CC *f)(B1, B2, B3, B4, B5, B6, B7, B8, B9),
           A1 a1,
           A2 a2,
           A3 a3,
           A4 a4,
