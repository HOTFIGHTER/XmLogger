...
/// forward declaration
template<
    BOOST_MPL_AUX_NTTP_DECL(int,
                            N), typename First, typename Last, typename State, typename ForwardOp
>
...
<
    ...
    typename apply2<ForwardOp, State, AUX778076_FOLD_IMPL_OP(First)>::type, ForwardOp
> res_;
