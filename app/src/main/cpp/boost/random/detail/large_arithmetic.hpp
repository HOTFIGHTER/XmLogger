...
inline mars_boost::uintmax_t muldiv(mars_boost::uintmax_t a,
                                    mars_boost::uintmax_t b,
                                    mars_boost::uintmax_t m) {
  return detail::muldivmod(a,
                           b,
                           m).quotient;
}

inline mars_boost::uintmax_t mulmod(mars_boost::uintmax_t a,
                                    mars_boost::uintmax_t b,
                                    mars_boost::uintmax_t m) {
  return detail::muldivmod(a,
                           b,
