...
template<>
struct Integer<::mars_boost::long_long_type> {};
template<>
struct Integer<::mars_boost::ulong_long_type> {};
...
# if defined(BOOST_HAS_LONG_LONG)
template<>
struct SignedInteger<::mars_boost::long_long_type> {};
# elif defined(BOOST_HAS_MS_INT64)
...
# if defined(BOOST_HAS_LONG_LONG)
template<>
struct UnsignedInteger<::mars_boost::ulong_long_type> {};
# elif defined(BOOST_HAS_MS_INT64)
...
BOOST_concept(AdaptablePredicate, (Func)(Arg))
    : UnaryPredicate<Func, Arg>, AdaptableUnaryFunction<Func, bool, Arg> {
};

BOOST_concept(AdaptableBinaryPredicate, (Func)(First)(Second))
    : BinaryPredicate<Func, First, Second>, AdaptableBinaryFunction<Func, bool, First, Second> {
};
...
BOOST_concept(InputIterator, (TT))
    : Assignable<TT>, EqualityComparable<TT> {
...
BOOST_concept(Mutable_BidirectionalIterator, (TT))
    : BidirectionalIterator<TT>, Mutable_ForwardIterator<TT> {
...
BOOST_concept(RandomAccessIterator, (TT))
    : BidirectionalIterator<TT>, Comparable<TT> {
  BOOST_CONCEPT_USAGE(RandomAccessIterator) {
    BOOST_CONCEPT_ASSERT((Convertible <
        BOOST_DEDUCED_TYPENAME
                             BidirectionalIterator<TT>::iterator_category
...
BOOST_concept(Mutable_RandomAccessIterator, (TT))
    : RandomAccessIterator<TT>, Mutable_BidirectionalIterator<TT> {
...
BOOST_concept(Mutable_ForwardContainer, (C))
    : ForwardContainer<C>, Mutable_Container<C> {
...
BOOST_concept(Mutable_ReversibleContainer, (C))
    : Mutable_ForwardContainer<C>, ReversibleContainer<C> {
...
BOOST_concept(Mutable_RandomAccessContainer, (C))
    : Mutable_ReversibleContainer<C>, RandomAccessContainer<C> {
 private:
...
BOOST_concept(AssociativeContainer, (C))
    : ForwardContainer<C>, DefaultConstructible<C> {
...
BOOST_concept(SortedAssociativeContainer, (C))
    : AssociativeContainer<C>, ReversibleContainer<C> {
