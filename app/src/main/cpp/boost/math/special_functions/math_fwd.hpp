...
template<class T, class Policy>
typename mars_boost::enable_if_c<policies::is_policy<Policy>::value,
...
template<class T1, class T2>
std::complex<typename detail::bessel_traits<T1, T2, policies::policy<> >::result_type>
...
typename tools::promote_args_permissive<T, U>::type
