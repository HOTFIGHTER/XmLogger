...
struct deduce_source_char_impl {
  ...
  ::detail::normalize_single_byte_char<Char>::type type;
};

template<class T>
struct deduce_source_char_impl<deduce_character_type_later < T> > {
typedef mars_boost::has_left_shift<std::basic_ostream < char>, T >
result_t;
...
BOOST_STATIC_ASSERT_MSG((result_t::value
|| mars_boost::has_left_shift<std::basic_ostream < type>, T >::value),
...
struct deduce_target_char_impl {
  typedef BOOST_DEDUCED_TYPENAME normalize_single_byte_char
  <Char>::type
  type;
};
...
typedef mars_boost::has_right_shift<std::basic_istream < char>, T >
result_t;
...
BOOST_STATIC_ASSERT_MSG((result_t::value
|| mars_boost::has_right_shift<std::basic_istream < wchar_t>, T >::value),
...
struct deduce_target_char {
  typedef BOOST_DEDUCED_TYPENAME stream_char_common
  <T>::type
  stage1_type;
  typedef BOOST_DEDUCED_TYPENAME deduce_target_char_impl
  <stage1_type>::type
  stage2_type;
...
struct deduce_source_char {
  ...
  <T>::type
  stage1_type;
  typedef BOOST_DEDUCED_TYPENAME deduce_source_char_impl
  <stage1_type>::type
  stage2_type;
...
struct lexical_cast_stream_traits {
  ...
  typedef BOOST_DEDUCED_TYPENAME mars_boost
  ::remove_cv<src>::type no_cv_src;

  typedef mars_boost::detail::deduce_source_char<no_cv_src> deduce_src_char_metafunc;
  typedef BOOST_DEDUCED_TYPENAME deduce_src_char_metafunc
  ::type src_char_t;
  typedef BOOST_DEDUCED_TYPENAME mars_boost
  ::detail::deduce_target_char<Target>::type target_char_t;
  ...
  typedef mars_boost::mpl::bool_
      <
          mars_boost::is_same<char, src_char_t>::value
              &&                                 // source is not a wide character based type
                  (sizeof(char) != sizeof(target_char_t))
              &&  // target type is based on wide character
      ...
      <
          !(mars_boost::is_integral<no_cv_src>::value ||
              mars_boost::detail::is_character<
                  ...
                  deduce_src_char_metafunc::stage1_type          // if we did not get character type at stage1
