...
class any {
 public: // structors
  ...
  remove_cv<BOOST_DEDUCED_TYPENAME decay<const ValueType>::type>::type
  >(value))
  {
  }
  ...
  template<typename ValueType>
  any(ValueType &&value,
      typename mars_boost::disable_if<mars_boost::is_same<any &,
                                                          ValueType> >::type * = 0 // disable if value has type `any&`
      ,
 ...
 private: // types
  ...
  class placeholder {
   ...
   public: // queries
    ...
    virtual const mars_boost::typeindex::type_info &type() const
    BOOST_NOEXCEPT = 0;
...
type()
==
mars_boost::typeindex::type_id<ValueType>()
...
ValueType any_cast(any &operand) {
  ...
  ::mpl::if_ <
      ...
      ValueType,
      BOOST_DEDUCED_TYPENAME
  mars_boost::add_reference<ValueType>::type
      > ::type
  ref_type;
