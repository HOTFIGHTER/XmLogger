...
class constant_iterator
 ...
 public:
  ...
  friend bool
  operator<(const constant_iterator &i, const constant_iterator &i2) { return i.less(i2); }

  friend bool operator>(const constant_iterator &i, const constant_iterator &i2) { return i2 < i; }
  ...
  friend Difference
  operator-(const constant_iterator &i, const constant_iterator &i2) { return i2.distance_to(i); }
  ...
  constant_iterator operator-(Difference off) const { return *this + (-off); }

  const T &operator*() const { return dereference(); }

  const T &operator[](Difference) const { return dereference(); }
 ...
 private:
  ...
  void decrement() { ++m_num; }

  bool equal(const this_type &other) const { return m_num == other.m_num; }

  bool less(const this_type &other) const { return other.m_num < m_num; }

  const T &dereference() const { return *m_ptr; }

  void advance(Difference n) { m_num -= n; }

  Difference distance_to(const this_type &other) const { return m_num - other.m_num; }
};
...
class value_init_construct_iterator
 ...
 public:
  ...
  friend bool operator==(const value_init_construct_iterator &i,
                         const value_init_construct_iterator &i2) { return i.equal(i2); }

  friend bool operator!=(const value_init_construct_iterator &i,
                         const value_init_construct_iterator &i2) { return !(i == i2); }

  friend bool operator<(const value_init_construct_iterator &i,
                        const value_init_construct_iterator &i2) { return i.less(i2); }

  friend bool operator>(const value_init_construct_iterator &i,
                        const value_init_construct_iterator &i2) { return i2 < i; }
  ...
  friend Difference operator-(const value_init_construct_iterator &i,
                              const value_init_construct_iterator &i2) { return i2.distance_to(i); }
  ...
  friend value_init_construct_iterator
  operator+(Difference off, const value_init_construct_iterator &right) { return right + off; }
  ...
  value_init_construct_iterator operator-(Difference off) const { return *this + (-off); }
...
class default_init_construct_iterator
 ...
 public:
  ...
  friend bool operator==(const default_init_construct_iterator &i,
                         const default_init_construct_iterator &i2) { return i.equal(i2); }

  friend bool operator!=(const default_init_construct_iterator &i,
                         const default_init_construct_iterator &i2) { return !(i == i2); }

  friend bool operator<(const default_init_construct_iterator &i,
                        const default_init_construct_iterator &i2) { return i.less(i2); }

  friend bool operator>(const default_init_construct_iterator &i,
                        const default_init_construct_iterator &i2) { return i2 < i; }
  ...
  friend Difference operator-(const default_init_construct_iterator &i,
                              const default_init_construct_iterator &i2) { return i2.distance_to(i); }
  ...
  operator+(Difference off, const default_init_construct_iterator &right) { return right + off; }
  ...
  default_init_construct_iterator operator-(Difference off) const { return *this + (-off); }
...
class repeat_iterator
 ...
 public:
  ...
  friend bool operator!=(const this_type &i, const this_type &i2) { return !(i == i2); }

  friend bool operator<(const this_type &i, const this_type &i2) { return i.less(i2); }

  friend bool operator>(const this_type &i, const this_type &i2) { return i2 < i; }

  friend bool operator<=(const this_type &i, const this_type &i2) { return !(i > i2); }

  friend bool operator>=(const this_type &i, const this_type &i2) { return !(i < i2); }

  friend Difference operator-(const this_type &i, const this_type &i2) { return i2.distance_to(i); }
  ...
  friend this_type operator+(Difference off, const this_type &right) { return right + off; }
  ...
  this_type operator-(Difference off) const { return *this + (-off); }

  T &operator*() const { return dereference(); }

  T &operator[](Difference) const { return dereference(); }
...
class emplace_iterator
 ...
 public:
  ...
  friend this_type operator+(difference_type off, const this_type &right) { return right + off; }
  ...
  this_type operator-(difference_type off) const { return *this + (-off); }
  ...
  void construct_in_place(Allocator &a, T *ptr) { (*m_pe)(a, ptr); }
 ...
 private:
  ...
  void advance(difference_type n) { m_num -= n; }
...
struct emplace_functor {
  ...
  emplace_functor (BOOST_FWD_REF(Args)
  ... args)
  :
  args_(args
  ...)
  ...
  void operator()(Allocator &a, T *ptr) { emplace_functor::inplace_impl(a, ptr, index_tuple_t()); }
...
struct is_forward_iterator {
  static const bool
      value = is_same<typename T::iterator_category, std::forward_iterator_tag>::value;
};
...
struct is_bidirectional_iterator {
  static const bool
      value = is_same<typename T::iterator_category, std::bidirectional_iterator_tag>::value;
};
...
struct iiterator_types {
  ...
  typedef typename mars_boost::container::iterator_traits<IIterator>::difference_type
      difference_type;
...
class iterator_from_iiterator {
 ...
 public:
  ...
  explicit iterator_from_iiterator(IIterator iit)
  BOOST_NOEXCEPT_OR_NOTHROW
      : m_iit(iit) {}

  iterator_from_iiterator(iterator_from_iiterator<IIterator, false> const &other)
  BOOST_NOEXCEPT_OR_NOTHROW
      :  m_iit(other.get()) {}

  iterator_from_iiterator &operator++()
  BOOST_NOEXCEPT_OR_NOTHROW
  {
    ++this->m_iit;
    return *this;
  ...
  iterator_from_iiterator operator++(int)
  BOOST_NOEXCEPT_OR_NOTHROW
  {
  ...
  friend bool operator==(const iterator_from_iiterator &l, const iterator_from_iiterator &r)
  BOOST_NOEXCEPT_OR_NOTHROW
