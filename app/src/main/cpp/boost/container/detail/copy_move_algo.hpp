...
template<class Pointer>
struct are_elements_contiguous<mars_boost::container::container_detail::vector_const_iterator<
    Pointer> > {
  static const bool value = true;
};
...
template<class PointedType, class DifferenceType, class OffsetType, std::size_t OffsetAlignment>
struct are_elements_contiguous<::mars_boost::interprocess::offset_ptr<PointedType,
                                                                      DifferenceType,
                                                                      OffsetType,
                                                                      OffsetAlignment> > {
  static const bool value = true;
...
struct are_contiguous_and_same
    : mars_boost::move_detail::and_
          <are_elements_contiguous<I>,
           ...
           is_same
               < typename remove_const<typename ::mars_boost::container::iterator_traits<I>::value_type>::type,
...
struct is_memtransfer_copy_assignable
    : mars_boost::move_detail::and_
      ...
      container_detail::is_trivially_copy_assignable<typename ::mars_boost::container::iterator_traits<
          I>::value_type>
> {
};
...
struct is_memtransfer_copy_constructible
    : mars_boost::move_detail::and_
          <are_contiguous_and_same < I, O>,
      container_detail::is_trivially_copy_constructible<typename ::mars_boost::container::iterator_traits<
          I>::value_type>
> {
};
...
inline F memmove(I f, I l, F r)
BOOST_NOEXCEPT_OR_NOTHROW
{
typedef typename mars_boost::container::iterator_traits<I>::value_type value_type;
typename mars_boost::container::iterator_traits<I>::difference_type
    n = mars_boost::container::iterator_distance(f, l);
if(n){
...
template
    <typename I, // I models InputIterator
        typename F>
// F models ForwardIterator
F memmove_n(I f, typename mars_boost::container::iterator_traits<I>::difference_type n, F r)
BOOST_NOEXCEPT_OR_NOTHROW
{
typedef typename mars_boost::container::iterator_traits<I>::value_type value_type;
if(n){
...
template
    <typename I, // I models InputIterator
        typename F>
// F models ForwardIterator
I memmove_n_source(I f, typename mars_boost::container::iterator_traits<I>::difference_type n, F r)
BOOST_NOEXCEPT_OR_NOTHROW
{
if(n){
typedef typename mars_boost::container::iterator_traits<I>::value_type value_type;
...
template
    <typename I, // I models InputIterator
        typename F>
// F models ForwardIterator
I memmove_n_source_dest(I f,
                        typename mars_boost::container::iterator_traits<I>::difference_type n,
                        F &r)
BOOST_NOEXCEPT_OR_NOTHROW
{
typedef typename mars_boost::container::iterator_traits<I>::value_type value_type;
...
struct is_memzero_initializable {
  ...
  static const bool value = are_elements_contiguous<O>::value &&
      (container_detail::is_integral<value_type>::value
          || container_detail::is_enum<value_type>::value
...
struct enable_if_trivially_destructible
    : enable_if_c<container_detail::is_trivially_destructible
                      <typename mars_boost::container::iterator_traits<I>::value_type>::value, R> {
};
...
uninitialized_move_alloc(Allocator &a, I f, I l, F r) {
  ...
  BOOST_TRY{
      while (f != l) {
        allocator_traits<Allocator>::construct(a,
                                               container_detail::iterator_to_raw_pointer(r),
                                               mars_boost::move(*f));
        ++f;
        ++r;
      }
...
uninitialized_move_alloc(Allocator &, I f, I l, F r)
BOOST_NOEXCEPT_OR_NOTHROW
{
return
container_detail::memmove(f, l, r
); }
...
// F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_constructible<I, F, F>::type
uninitialized_move_alloc_n(Allocator &a,
                           I f,
                           typename mars_boost::container::iterator_traits<I>::difference_type n,
                           F r) {
  F back = r;
...
// F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
uninitialized_move_alloc_n(Allocator &,
                           I f,
                           typename mars_boost::container::iterator_traits<I>::difference_type n,
                           F r)
BOOST_NOEXCEPT_OR_NOTHROW
{
return
container_detail::memmove_n(f, n, r
); }
...
uninitialized_move_alloc_n_source(Allocator &a,
                                  I f,
                                  typename mars_boost::container::iterator_traits<I>::difference_type n,
                                  F r) {
  F back = r;
...
uninitialized_move_alloc_n_source(Allocator &,
                                  I f,
                                  typename mars_boost::container::iterator_traits<I>::difference_type n,
                                  F r)
BOOST_NOEXCEPT_OR_NOTHROW
{
return
container_detail::memmove_n_source(f, n, r
); }
...
// F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
uninitialized_copy_alloc(Allocator &, I f, I l, F r)
BOOST_NOEXCEPT_OR_NOTHROW
{
return
container_detail::memmove(f, l, r
...
// F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_constructible<I, F, F>::type
uninitialized_copy_alloc_n(Allocator &a,
                           I f,
                           typename mars_boost::container::iterator_traits<I>::difference_type n,
                           F r) {
  F back = r;
...
// F models ForwardIterator
inline typename container_detail::enable_if_memtransfer_copy_constructible<I, F, F>::type
uninitialized_copy_alloc_n(Allocator &,
                           I f,
                           typename mars_boost::container::iterator_traits<I>::difference_type n,
                           F r)
BOOST_NOEXCEPT_OR_NOTHROW
...
// F models ForwardIterator
inline typename container_detail::disable_if_memtransfer_copy_constructible<I, F, I>::type
uninitialized_copy_alloc_n_source(Allocator &a,
                                  I f,
                                  typename mars_boost::container::iterator_traits<I>::difference_type n,
                                  F r) {
  F back = r;
...
uninitialized_value_init_alloc_n(Allocator &a,
                                 typename allocator_traits<Allocator>::difference_type n,
                                 F r) {
  F back = r;
  BOOST_TRY{
      while (n--) {
...
uninitialized_value_init_alloc_n(Allocator &,
                                 typename allocator_traits<Allocator>::difference_type n,
                                 F r) {
...
template
    <typename Allocator,
        typename F>
// F models ForwardIterator
inline F uninitialized_default_init_alloc_n(Allocator &a,
                                            typename allocator_traits<Allocator>::difference_type n,
                                            F r) {
  F back = r;
  BOOST_TRY{
...
template
    <typename Allocator,
        ...
        typename F>
// F models ForwardIterator
inline F uninitialized_fill_alloc_n(Allocator &a,
                                    const T &v,
                                    typename allocator_traits<Allocator>::difference_type n,
                                    F r) {
  F back = r;
...
{
return
container_detail::memmove_n_source_dest(f, n, r
);  }
...
{
typedef typename mars_boost::container::iterator_traits<I>::value_type value_type;
const typename mars_boost::container::iterator_traits<I>::difference_type
    n = mars_boost::container::iterator_distance(f, l);
r -=
n;
std::memmove((container_detail::iterator_to_raw_pointer)(r),
(container_detail::iterator_to_raw_pointer)(f),
sizeof(value_type)*n);
return
r;
}
...
template
    <typename Allocator, typename I   // I models InputIterator
        , typename U>
// U models unsigned integral constant
...
template
    <std::size_t MaxTmpBytes, typename Allocator, typename F // F models ForwardIterator
        , typename G // G models ForwardIterator
    >
inline typename container_detail::disable_if_memtransfer_copy_assignable<F, G, void>::type
deep_swap_alloc_n(Allocator &a,
                  F short_range_f,
                  typename allocator_traits<Allocator>::size_type n_i,
                  G large_range_f,
                  typename allocator_traits<Allocator>::size_type n_j) {
  ...
  mars_boost::container::uninitialized_move_alloc_n(a,
                                                    large_range_f,
                                                    n_j - n_i,
                                                    short_range_f);  // may throw
...
inline typename container_detail::enable_if_c
    <container_detail::is_memtransfer_copy_assignable<F, G>::value
         && (MaxTmpBytes <= DeepSwapAllocNMaxStorage) && false, void>::type
deep_swap_alloc_n(Allocator &a,
                  F short_range_f,
                  typename allocator_traits<Allocator>::size_type n_i,
                  G large_range_f,
  ...
  void *const large_ptr =
      static_cast<void *>(container_detail::iterator_to_raw_pointer(large_range_f));
  void *const short_ptr =
      static_cast<void *>(container_detail::iterator_to_raw_pointer(short_range_f));
...
inline typename container_detail::enable_if_c
    <container_detail::is_memtransfer_copy_assignable<F, G>::value
         && true//(MaxTmpBytes > DeepSwapAllocNMaxStorage)
        , void>::type
deep_swap_alloc_n(Allocator &a,
                  F short_range_f,
                  typename allocator_traits<Allocator>::size_type n_i,
  ...
  typedef typename allocator_traits<Allocator>::value_type value_type;
  typedef typename container_detail::aligned_storage
      <DeepSwapAllocNMaxStorage, container_detail::alignment_of<value_type>::value>::type
      storage_type;
  storage_type storage;
  ...
  char *large_ptr =
      static_cast<char *>(static_cast<void *>(container_detail::iterator_to_raw_pointer(
          large_range_f)));
  char *short_ptr =
      static_cast<char *>(static_cast<void *>(container_detail::iterator_to_raw_pointer(
          short_range_f)));
...
template
    <typename Allocator, typename I // F models InputIterator
        , typename O // G models OutputIterator
    >
void copy_assign_range_alloc_n(Allocator &a,
                               I inp_start,
                               typename allocator_traits<Allocator>::size_type n_i,
                               O out_start,
                               typename allocator_traits<Allocator>::size_type n_o) {
  if (n_o < n_i) {
    inp_start =
        mars_boost::container::copy_n_source_dest(inp_start, n_o, out_start);     // may throw
    mars_boost::container::uninitialized_copy_alloc_n(a,
                                                      inp_start,
                                                      n_i - n_o,
                                                      out_start);// may throw
  } else {
...
template
    <typename Allocator, typename I // F models InputIterator
        , typename O // G models OutputIterator
    >
void move_assign_range_alloc_n(Allocator &a,
                               I inp_start,
                               typename allocator_traits<Allocator>::size_type n_i,
                               O out_start,
                               typename allocator_traits<Allocator>::size_type n_o) {
