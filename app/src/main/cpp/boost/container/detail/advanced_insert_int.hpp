...
struct insert_range_proxy {
  ...
  void uninitialized_copy_n_and_update(Allocator &a, Iterator p, size_type n) {
    this->first_ =
        ::mars_boost::container::uninitialized_copy_alloc_n_source(a, this->first_, n, p);
  }
...
struct insert_n_copies_proxy {
  ...
  void uninitialized_copy_n_and_update(Allocator &a,
                                       Iterator p,
                                       size_type n) const {
    mars_boost::container::uninitialized_fill_alloc_n(a,
                                                      v_,
                                                      n,
                                                      p);
  }
...
struct insert_value_initialized_n_proxy {
  ...
  void uninitialized_copy_n_and_update(Allocator &a,
                                       Iterator p,
                                       size_type n) const {
    mars_boost::container::uninitialized_value_init_alloc_n(a,
                                                            n,
                                                            p);
  }

  void copy_n_and_update(Allocator &, Iterator, size_type) const { BOOST_ASSERT(false); }
};
...
struct insert_default_initialized_n_proxy {
  ...
  void uninitialized_copy_n_and_update(Allocator &a,
                                       Iterator p,
                                       size_type n) const {
    mars_boost::container::uninitialized_default_init_alloc_n(a,
                                                              n,
                                                              p);
  }
...
insert_move_proxy<Allocator, It>
get_insert_value_proxy(BOOST_RV_REF(typename mars_boost::container::iterator_traits<It>::value_type)
                       v) {
  return insert_move_proxy<Allocator, It>(v);
}

template<class It, class Allocator>
insert_copy_proxy<Allocator, It>
get_insert_value_proxy(const typename mars_boost::container::iterator_traits<It>::value_type &v) {
...
struct insert_nonmovable_emplace_proxy {
  ...
  explicit insert_nonmovable_emplace_proxy (BOOST_FWD_REF(Args)
  ... args)
  :
  args_(args
  ...)
  ...
  void uninitialized_copy_n_and_update(Allocator &a,
                                       Iterator p,
                                       size_type n) {
    this->priv_uninitialized_copy_some_and_update(a,
                                                  index_tuple_t(),
                                                  p,
                                                  n);
  }
 ...
 private:
  ...
  void priv_uninitialized_copy_some_and_update(Allocator &a,
                                               const index_tuple<IdxPack...> &,
                                               Iterator p,
                                               size_type n) {
    BOOST_ASSERT(n == 1);
    (void) n;
    alloc_traits::construct(a,
                            iterator_to_raw_pointer(p),
...
struct insert_emplace_proxy
  ...
  explicit insert_emplace_proxy (BOOST_FWD_REF(Args)
  ... args)
  :
  ...
  void copy_n_and_update(Allocator &a, Iterator p, size_type n) {
    this->priv_copy_some_and_update(a,
                                    index_tuple_t(),
                                    p,
                                    n);
  }
 ...
 private:
  ...
  template<int ...IdxPack>
  void priv_copy_some_and_update(Allocator &a,
                                 const index_tuple<IdxPack...> &,
                                 Iterator p,
                                 size_type n) {
    BOOST_ASSERT(n == 1);
...
struct insert_emplace_proxy<Allocator,
                            Iterator,
                            typename mars_boost::container::allocator_traits<Allocator>::value_type>
...
struct insert_emplace_proxy<Allocator,
                            Iterator,
                            typename mars_boost::container::container_detail::add_const<typename mars_boost::container::allocator_traits<
                                Allocator>::value_type>::type
>
