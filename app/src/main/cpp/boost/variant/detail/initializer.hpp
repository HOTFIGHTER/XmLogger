...
struct make_initializer_node {
  ...
  struct apply {
   private: // helpers, for metafunction result (below)
    ...
    class initializer_node
     ...
     private: // helpers, for static functions (below)
      ...
      typedef typename mars_boost::mpl::if_<is_reference_content_t,
                                            public_T,
                                            const public_T &>::type
          param_T;
     ...
     public: // static functions
      ...
      static int initialize(void *dest, param_T operand) {
        ...
        return BOOST_MPL_AUX_VALUE_WKND(index)
        ::value; // which
      }
      ...
      static int initialize(void *dest, param2_T operand) {
        ...
        typedef typename mars_boost::mpl::if_<is_reference_content_t,
                                              param2_T,
                                              recursive_enabled_T>::type value_T;
   ...
   public: // metafunction result
    ...
    typedef mpl::pair<
        initializer_node, typename mpl::next<index>::type
    > type;
