  ...
  struct apply
      : mpl::size_t<
          ::mars_boost::math::static_lcm<
              BOOST_MPL_AUX_VALUE_WKND(State)::value, ::mars_boost::alignment_of<Item>::value
          >::value
      > {
  };
};
...
struct make_storage {
 ...
 public: // metafunction result
  ...
  typedef ::mars_boost::aligned_storage<
      BOOST_MPL_AUX_VALUE_WKND(max_size)
  ::value
  , BOOST_MPL_AUX_VALUE_WKND(max_alignment)
  ::value
  > type;
};
...
class move_into
 ...
 public: // internal visitor interface
  ...
  BOOST_VARIANT_AUX_RETURN_VOID_TYPE
  internal_visit(T &operand, int) const
  BOOST_NOEXCEPT_IF (BOOST_NOEXCEPT_EXPR(T(mars_boost::declval<T>()))) {
...
class backup_assigner
 ...
 private: // helpers, for visitor interface (below)
  ...
  void backup_assign_impl(
      backup_holder <LhsT> &lhs_content, mpl::false_ // is_nothrow_move_constructible, long
  ) {
  ...
  template<typename LhsT>
  void backup_assign_impl(
      LhsT &lhs_content, mpl::true_ // is_nothrow_move_constructible, int
  ) {
    // Move lhs content to backup...
  ...
  template<typename LhsT>
  void backup_assign_impl(
      LhsT &lhs_content, mpl::false_ // is_nothrow_move_constructible, int
  ) {
    // Backup lhs content...
...
class reflect
 ...
 public: // visitor interfaces
  ...
  template<typename T>
  const mars_boost::typeindex::type_info &operator()(const T &) const
  BOOST_NOEXCEPT
  {
...
#   endif
 ...
 public: // internal visitor interfaces, cont.
  ...
  template<typename T>
  BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
  internal_visit(mars_boost::recursive_wrapper<T>
  & operand, long)
  {
  ...
  template<typename T>
  BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
  internal_visit(mars_boost::detail::reference_content<T>
  & operand, long)
  {
    return internal_visit(operand.get(), 1L);
  }
  ...
  template<typename T>
  BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
  internal_visit(mars_boost::detail::variant::backup_holder<T>
  & operand, long)
  {
    return internal_visit(operand.get(), 1L);
  }
...
//
template<
    typename T0_, BOOST_VARIANT_ENUM_SHIFTED_PARAMS(typename T)
>
class variant {
 private: // helpers, for typedefs (below)
  ...
  typedef typename mpl::eval_if<
      is_recursive_, T0_, mpl::identity < T0_>
  >
  ::type unwrapped_T0_;
 ...
 private: // helpers, for typedefs (below)
  ...
  typedef typename mpl::eval_if<
      ...
      , detail::variant::make_variant_list<
          unwrapped_T0_, BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
      >
  >::type specified_types;

  BOOST_STATIC_ASSERT((
      ::mars_boost::mpl::not_<mpl::empty < specified_types>
  >::value
  ));

  typedef typename mpl::eval_if<
      is_recursive_, mpl::transform <
          specified_types, mpl::protect <
 ...
 public: // public typedefs
  ...
  typedef typename mpl::transform<
      recursive_enabled_types, unwrap_recursive < mpl::_1>
  >
  ::type types;
 ...
 private: // internal typedefs
  ...
  typedef typename mpl::transform<
      recursive_enabled_types, mpl::protect < detail::make_reference_content<> >
  >
  ::type internal_types;
...
#   endif
 ...
 private: // helpers, for structors, below
  ...
  void convert_construct(
      T &operand, int, mpl::false_ = mpl::false_() // is_foreign_variant
  ) {
    // NOTE TO USER :
  ...
  typename mars_boost::enable_if<mars_boost::is_rvalue_reference<T &&> >::type convert_construct(
    ...
    indicate_which(
        initializer::initialize(
            storage_.address(), detail::variant::move(operand)
        )
    );
  }
#endif
  ...
  template<typename Variant>
  void convert_construct(
      Variant &operand, long, mpl::true_// is_foreign_variant
  ) {
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
  template<typename Variant>
  typename mars_boost::enable_if<mars_boost::is_rvalue_reference<Variant &&> >::type
  convert_construct(
      Variant &&operand, long, mpl::true_// is_foreign_variant
  ) {
  ...
  convert_construct_variant(Variant &&operand) {
    ...
    convert_construct(
        detail::variant::move(operand), 1L, is_foreign_variant()
    );
  }
#endif
  ...
  void convert_construct(
      mars_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)> &operand, long
  ) {
  ...
  template<BOOST_VARIANT_ENUM_PARAMS(typename U)>
  void convert_construct(
      const mars_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)> &operand, long
  ) {
    convert_construct_variant(operand);
  }
 ...
 public: // structors, cont.
  ...
  template<class T>
  variant(T &&operand,
          typename mars_boost::enable_if<mars_boost::is_rvalue_reference<T &&> >::type * = 0,
...
#   endif
  ...
  class assigner
   ...
   protected: // helpers, for internal visitor interface (below)
    ...
    BOOST_NOEXCEPT {
      ...
      lhs_.indicate_which(
          BOOST_MPL_AUX_VALUE_WKND(fallback_type_index_)
      ::value
      ); // nothrow
    }
   ...
   public: // internal visitor interfaces
    ...
    internal_visit(const RhsT &rhs_content, int) const {
      ...
      typedef typename mpl::or_< // reduces compile-time
          nothrow_copy, is_nothrow_move_constructible < RhsT>
      >::type nothrow_move_constructor;

      assign_impl(
          rhs_content, nothrow_copy(), nothrow_move_constructor(), has_fallback_type_()
      );
  ...
  class move_assigner
   ...
   public: // internal visitor interfaces
    ...
    internal_visit(RhsT &rhs_content, int) const {
      ...
      typedef typename mpl::or_< // reduces compile-time
          nothrow_move_constructor, has_nothrow_copy < RhsT>
      >::type nothrow_copy;
 ...
 public: // modifiers
  ...
  typename mars_boost::enable_if_c<
      mars_boost::is_rvalue_reference<T &&>::value && !mars_boost::is_const<T>::value,
      variant &>::type
  operator=(T &&rhs) {
...
// helpers, for visitation support (below) -- private when possible
 ...
 private:
  ...
  internal_apply_visitor_impl(
      int internal_which, int logical_which, Visitor &visitor, VoidPtrCV storage
  ) {
...
inline void swap(
    variant<BOOST_VARIANT_ENUM_PARAMS(T)> &lhs, variant<BOOST_VARIANT_ENUM_PARAMS(T)> &rhs
) {
  lhs.swap(rhs);
}
