...
BOOST_DATE_TIME_DECL mars_boost::date_time::all_date_names_put<greg_facet_config, char>
*
...
/* Necessary in the event an exception is thrown from op>> for
 * weekday or month. See comments in those functions for more info */
BOOST_DATE_TIME_DECL mars_boost::date_time::all_date_names_put<greg_facet_config, wchar_t>
*
