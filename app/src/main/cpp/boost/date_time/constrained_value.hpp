...
class constrained_value {
 public:
  ...
  BOOST_PREVENT_MACRO_SUBSTITUTION() { return (value_policies::max)(); }
  //! Return the min allowed value (traits method)
  static value_type min
  BOOST_PREVENT_MACRO_SUBSTITUTION() { return (value_policies::min)(); }
...
class simple_exception_policy {
 ...
 public:
  ...
  static rep_type min
  BOOST_PREVENT_MACRO_SUBSTITUTION() { return min_value; }
  static rep_type max
  BOOST_PREVENT_MACRO_SUBSTITUTION() { return max_value; }
