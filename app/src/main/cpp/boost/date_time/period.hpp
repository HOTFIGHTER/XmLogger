...
class period: private mars_boost::less_than_comparable<period<point_rep, duration_rep>,
                                                       mars_boost::equality_comparable<period<
                                                           point_rep,
                                                           duration_rep>
                                                       > > {
 public:
...
inline
bool
period<point_rep, duration_rep>::intersects(const period<point_rep, duration_rep> &other) const {
  ...
  if (this->intersects(other)) {
    if (begin_ < other.begin_) {
      return period<point_rep, duration_rep>(begin_,
                                             last_ > other.last_ ? this->end() : other.end());
    }

    return period<point_rep, duration_rep>(other.begin_,
                                           last_ > other.last_ ? this->end() : other.end());
