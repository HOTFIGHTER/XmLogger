...
# else
  ...
  static time_rep_type subtract_time_duration(const time_rep_type &base,
    ...
    date_duration_type day_overflow
        (static_cast<typename date_duration_type::duration_rep_type>(day_offset.subtract(td.ticks())));
  ...
  static time_rep_type add_time_duration(const time_rep_type &base,
    ...
    wrap_int_type day_offset(base.time_of_day.ticks());
    date_duration_type day_overflow
        (static_cast< typename date_duration_type::duration_rep_type >(day_offset.add(td.ticks())));
