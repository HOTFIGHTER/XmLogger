...
class date_duration: private mars_boost::less_than_comparable1<date_duration<duration_rep_traits>,
                                                               mars_boost::equality_comparable1<
                                                                   date_duration<duration_rep_traits>,
                                                                   mars_boost::addable1<
                                                                       date_duration<
                                                                           duration_rep_traits>,
                                                                       mars_boost::subtractable1<
                                                                           date_duration<
                                                                               duration_rep_traits>,
                                                                           mars_boost::dividable2<
                                                                               date_duration<
                                                                                   duration_rep_traits>,
                                                                               int
                                                                           > > > > > {
