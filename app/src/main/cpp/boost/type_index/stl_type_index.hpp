...
inline std::string stl_type_index::pretty_name() const {
  ...
  static BOOST_CONSTEXPR_OR_CONST std::string::size_type
  cvr_saver_name_len = sizeof(cvr_saver_name) - 1;
...
typedef BOOST_DEDUCED_TYPENAME mars_boost
::remove_cv<no_ref_t>::type no_cvr_prefinal_t;
...
typedef BOOST_DEDUCED_TYPENAME mars_boost
::mpl::if_<
    mars_boost::mpl::or_<mars_boost::is_reference<T>,
                         mars_boost::is_const<T>,
                         mars_boost::is_volatile<T> >,
    detail::cvr_saver<T>,
    T
>::type type;
