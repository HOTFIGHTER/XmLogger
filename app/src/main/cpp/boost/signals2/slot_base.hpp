...
typedef mars_boost::variant<mars_boost::weak_ptr<trackable_pointee>,
                            mars_boost::weak_ptr<void>,
                            detail::foreign_void_weak_ptr> void_weak_ptr_variant;
typedef mars_boost::variant<mars_boost::shared_ptr<void>, detail::foreign_void_shared_ptr>
