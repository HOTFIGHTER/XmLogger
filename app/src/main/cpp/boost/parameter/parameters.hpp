...
BOOST_DETAIL_IS_XXX_DEF(required, required,
2)
BOOST_DETAIL_IS_XXX_DEF(optional, optional,
2)
BOOST_DETAIL_IS_XXX_DEF(deduced_aux, deduced,
1)
...
struct is_named_argument
    : mpl::or_<
        is_template_keyword < T>, is_tagged_argument<T>
>
{
};
...
struct satisfies_requirements_of
    : satisfies<
        ArgList, typename as_parameter_requirements<ParameterSpec>::type
    > {
};
...
template<
    class Argument, class ArgumentPack, class DeducedArgs, class UsedArgs, class TagFn
>
struct deduce_tag;
...
struct deduce_tag0 {
  ...
  BOOST_MPL_ASSERT((
      mpl::not_<mpl::and_ <
      condition, aux::has_key_ < UsedArgs, typename tag_type<spec>::type>
  > >
  ));
...
template<
    class List, class DeducedArgs, class TagFn, class Positional, class UsedArgs, class ArgumentPack, class Error
>
...
template<
    class List, class DeducedArgs, class TagFn, class Positional, class UsedArgs, class ArgumentPack
...
#endif
{
  ...
  typedef typename mpl::eval_if<
      is_tagged, insert_tagged<UsedArgs, argument>, mpl::identity < UsedArgs>
  >::type used_args;
  ...
  typedef typename mpl::eval_if<
      is_tagged, mpl::identity < argument>                        // .. just use it
...
template<
    class List, class DeducedArgs, class TagFn, class Positional, class DeducedSet, class ArgumentPack, class Error
>
struct make_arg_list_aux {
  typedef typename mpl::eval_if<
      is_same < List, void_>
...
template<
    class List, class DeducedArgs, class TagFn, class EmitErrors = mpl::true_
>
...
template<
    class PS0, BOOST_PP_ENUM_SHIFTED(BOOST_PARAMETER_MAX_ARITY, BOOST_PARAMETER_TEMPLATE_ARGS, _)
>
struct parameters {
...
# endif
  ...
  typename mpl::first<
      typename aux::make_arg_list<
          aux::item <
              PS0, A0
      >, deduced_list, aux::tag_keyword_arg
  >::type
  >
  ::type
  operator()(A0 &a0) const {
    ...
    BOOST_PP_ENUM_TRAILING_PARAMS(
        BOOST_PP_SUB(BOOST_PARAMETER_MAX_ARITY, 1), aux::void_reference()
    BOOST_PP_INTERCEPT)
    );
  }
  ...
  operator()(A0 &a0, A1 &a1) const {
    ...
    // , void_(), void_() ...
    BOOST_PP_ENUM_TRAILING_PARAMS(
        BOOST_PP_SUB(BOOST_PARAMETER_MAX_ARITY, 2), aux::void_reference()
    BOOST_PP_INTERCEPT)
    );
  }
