...
struct enable_if_convertible
    : iterators::enable_if<
        is_convertible<From, To>, mars_boost::iterators::detail::enable_type
    > {
};
...
# ifdef BOOST_ITERATOR_REF_CONSTNESS_KILLS_WRITABILITY
      , typename mars_boost::iterators::detail::ia_dflt_help<
          Value, mpl::eval_if <
              is_same < Reference, use_default>, iterator_value<Base>, remove_reference<Reference>
  >
  >::type
# else
  , typename mars_boost::iterators::detail::ia_dflt_help<
...
# endif
  ...
  , typename mars_boost::iterators::detail::ia_dflt_help<
      Traversal, iterator_traversal < Base>
  >::type
...
class iterator_adaptor
 ...
 protected:
  ...
  typedef iterator_adaptor<Derived, Base, Value, Traversal, Reference, Difference>
      iterator_adaptor_;
