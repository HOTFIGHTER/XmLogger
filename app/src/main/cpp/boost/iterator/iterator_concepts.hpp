...
BOOST_concept(ReadableIterator, (Iterator))
    : mars_boost::Assignable<Iterator>, mars_boost::CopyConstructible<Iterator> {
  typedef BOOST_DEDUCED_TYPENAME mars_boost::detail::iterator_traits<Iterator>::value_type
      value_type;
...
template<
    typename Iterator, typename ValueType = BOOST_DEDUCED_TYPENAME mars_boost::detail::iterator_traits<
        Iterator>::value_type
>
...
BOOST_concept(IncrementableIterator, (Iterator))
  ...
  BOOST_CONCEPT_ASSERT((
                           mars_boost::Convertible<
                               traversal_category, mars_boost::incrementable_traversal_tag
                           >));
...
BOOST_concept(SinglePassIterator, (Iterator))
    : IncrementableIterator<Iterator>, mars_boost::EqualityComparable<Iterator> {
  BOOST_CONCEPT_ASSERT((
                           mars_boost::Convertible<
...
BOOST_concept(ForwardTraversal, (Iterator))
    : SinglePassIterator<Iterator>, mars_boost::DefaultConstructible<Iterator> {
...
BOOST_concept(InteroperableIterator, (Iterator)(ConstIterator)) {
 private:
  typedef typename mars_boost::iterators::pure_iterator_traversal<Iterator>::type
      traversal_category;
  typedef typename mars_boost::iterators::pure_iterator_traversal<ConstIterator>::type
 ...
 public:
  ...
  BOOST_CONCEPT_USAGE(InteroperableIterator) {
    ...
    detail::interop_rand_access_constraints(i,
                                            ci,
                                            traversal_category(),
                                            const_traversal_category());
