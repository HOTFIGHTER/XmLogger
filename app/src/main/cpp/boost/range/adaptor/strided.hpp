...
class strided_iterator
  ...
  typedef iterator_facade<
      strided_iterator<BaseIterator,
                       Category>, typename iterator_value<BaseIterator>::type, forward_traversal_tag,
                                  typename iterator_reference<BaseIterator>::type,
                                  typename iterator_difference<BaseIterator>::type
  > super_t;
...
class strided_iterator<BaseIterator, bidirectional_traversal_tag>
  ...
  typedef iterator_facade<
      strided_iterator<BaseIterator, bidirectional_traversal_tag>, typename iterator_value<
          BaseIterator>::type, bidirectional_traversal_tag,
                                                                   typename iterator_reference<
                                                                       BaseIterator>::type,
 ...
 public:
  ...
  strided_iterator(
      ...
      : m_it(other.base()), m_offset(other.get_offset()), m_index(other.get_index()),
...
class strided_iterator<BaseIterator, random_access_traversal_tag>
  ...
  typedef iterator_facade<
      strided_iterator<BaseIterator, random_access_traversal_tag>, typename iterator_value<
          BaseIterator>::type, random_access_traversal_tag,
                                                                   typename iterator_reference<
                                                                       BaseIterator>::type,
                                                                   typename iterator_difference<
                                                                       BaseIterator>::type
 ...
 public:
  ...
  strided_iterator(
      ...
      : m_it(it), m_first(first), m_index(stride ? (it - first) : difference_type()),
        m_stride(stride) {
    if (stride && ((m_index % stride) != 0))
      m_index += (stride - (m_index % stride));
  }
  ...
  strided_iterator(
      ...
      : m_it(other.base()), m_first(other.base_begin()), m_index(other.get_index()),
        m_stride(other.get_stride()) {
  }
