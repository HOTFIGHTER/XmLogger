...
search_n_impl(ForwardIterator first, ForwardIterator last,
  ...
  BOOST_RANGE_CONCEPT_ASSERT((EqualityComparableConcept
...
return
range_detail::search_n_impl(mars_boost::begin(rng), mars_boost::end(rng), count, value
);
}
...
BOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
                                                   ...
                                                   range_value<ForwardRange>::type,
                                                   const Value &>));
return
range_detail::search_n_pred_impl(mars_boost::begin(rng), mars_boost::end(rng),
...
search_n(const ForwardRange &rng, Integer count, const Value &value,
  ...
  BOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept < BinaryPredicate,
      BOOST_DEDUCED_TYPENAME
  range_value<const ForwardRange>::type,
  const Value&>));
