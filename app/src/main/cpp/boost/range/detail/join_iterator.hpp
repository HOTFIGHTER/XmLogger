...
template<typename Iterator1, typename Iterator2, typename ValueType = typename iterator_value<
    Iterator1>::type
...
>
class join_iterator
    : public iterator_facade<join_iterator<Iterator1, Iterator2, ValueType, Reference, Traversal>,
                             ValueType,
                             Traversal,
                             Reference> {
 ...
 public:
  ...
  join_iterator()
      : m_section(0u), m_it(0u, iterator1_t(), iterator2_t()),
        m_link(link_t(iterator1_t(), iterator2_t())) {}

  join_iterator(unsigned int section,
                Iterator1 current1,
                Iterator1 last1,
                Iterator2 first2,
                Iterator2 current2)
  ...
  join_iterator(const Range1 &r1, const Range2 &r2, join_iterator_begin_tag)
      : m_section(mars_boost::empty(r1) ? 1u : 0u), m_it(mars_boost::empty(r1) ? 1u : 0u,
                                                         mars_boost::const_begin(r1),
                                                         mars_boost::const_begin(r2)),
