...
struct range_helper {
  ...
  BOOST_STATIC_CONSTANT(bool,
                        is_pair_ =
                            sizeof(mars_boost::range_detail::is_pair_impl(c)) == sizeof(yes_type));
  BOOST_STATIC_CONSTANT(bool,
                        is_char_ptr_ = sizeof(mars_boost::range_detail::is_char_ptr_impl(ptr))
                            == sizeof(yes_type));
  BOOST_STATIC_CONSTANT(bool,
                        is_const_char_ptr_ =
                            sizeof(mars_boost::range_detail::is_const_char_ptr_impl(ptr))
                                == sizeof(yes_type));
  BOOST_STATIC_CONSTANT(bool,
                        is_wchar_t_ptr_ = sizeof(mars_boost::range_detail::is_wchar_t_ptr_impl(ptr))
                            == sizeof(yes_type));
  BOOST_STATIC_CONSTANT(bool,
                        is_const_wchar_t_ptr_ =
                            sizeof(mars_boost::range_detail::is_const_wchar_t_ptr_impl(ptr))
                                == sizeof(yes_type));
  BOOST_STATIC_CONSTANT(bool,
                        is_char_array_ = sizeof(mars_boost::range_detail::is_char_array_impl(ptr))
                            == sizeof(yes_type));
  BOOST_STATIC_CONSTANT(bool,
                        is_wchar_t_array_ =
                            sizeof(mars_boost::range_detail::is_wchar_t_array_impl(ptr))
                                == sizeof(yes_type));
  BOOST_STATIC_CONSTANT(bool,
                        is_string_ = (mars_boost::mpl::or_<boost::mpl::bool_<is_const_char_ptr_>,
                                                           mars_boost::mpl::bool_<
                                                               is_const_wchar_t_ptr_> >::value));
