...
struct any_single_pass_iterator_interface
  ...
  typedef typename any_incrementable_iterator_interface<Reference, Buffer>::const_reference
      const_reference;
...
struct any_forward_iterator_interface
  ...
  typedef typename any_single_pass_iterator_interface<Reference, Buffer>::const_reference
      const_reference;
...
struct any_bidirectional_iterator_interface
  ...
  typedef typename any_forward_iterator_interface<Reference, Buffer>::const_reference
      const_reference;
...
struct any_random_access_iterator_interface
  ...
  typedef typename any_bidirectional_iterator_interface<Reference, Buffer>::const_reference
      const_reference;
