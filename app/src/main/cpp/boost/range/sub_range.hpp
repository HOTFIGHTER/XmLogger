...
class sub_range_base
 ...
 protected:
  ...
  ::iterator_range_ iterator_range_;

 public:
  typedef BOOST_DEDUCED_TYPENAME range_value
  <ForwardRange>::type
  value_type;
  ...
  iterator;
  typedef BOOST_DEDUCED_TYPENAME range_iterator
  <const ForwardRange>::type
  const_iterator;
  typedef BOOST_DEDUCED_TYPENAME range_difference
  <ForwardRange>::type
  difference_type;
  typedef BOOST_DEDUCED_TYPENAME range_size
  <ForwardRange>::type
  size_type;
