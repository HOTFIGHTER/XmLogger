...
typedef BOOST_DEDUCED_TYPENAME CMap
<KEY, ARG_KEY, VALUE, ARG_VALUE> map_type;
typedef BOOST_DEDUCED_TYPENAME range_reference
<const map_type>::type
argument_type;
typedef BOOST_DEDUCED_TYPENAME const KEY
&
result_type;
...
<map_type>::type
argument_type;
typedef BOOST_DEDUCED_TYPENAME VALUE
&
result_type;
...
struct select_second_const<CMap<KEY, ARG_KEY, VALUE, ARG_VALUE> > {
  ...
  <const map_type>::type
  argument_type;
  typedef BOOST_DEDUCED_TYPENAME const VALUE
  &
  result_type;
