...
struct SinglePassIteratorConcept
    : IncrementableIteratorConcept<Iterator>, EqualityComparable<Iterator> {
#if BOOST_RANGE_ENABLE_CONCEPT_ASSERT
  BOOST_RANGE_CONCEPT_ASSERT((
                                 Convertible<
...
struct ForwardIteratorConcept
    : SinglePassIteratorConcept<Iterator>, DefaultConstructible<Iterator> {
#if BOOST_RANGE_ENABLE_CONCEPT_ASSERT
  typedef BOOST_DEDUCED_TYPENAME mars_boost::detail::iterator_traits<Iterator>::difference_type
      difference_type;
...
struct WriteableForwardRangeConcept
    : ForwardRangeConcept<T>, WriteableRangeConcept<T> {
};
...
struct WriteableBidirectionalRangeConcept
    : BidirectionalRangeConcept<T>, WriteableRangeConcept<T> {
};
...
struct WriteableRandomAccessRangeConcept
    : RandomAccessRangeConcept<T>, WriteableRangeConcept<T> {
};
