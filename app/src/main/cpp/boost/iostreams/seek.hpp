...
struct seek_device_impl<two_head> {
  ...
  static std::streampos seek(T &t, stream_offset off,
                             BOOST_IOS::seekdir way,
                             BOOST_IOS::openmode which) { return t.seek(off, way, which); }
};
...
struct seek_device_impl<any_tag> {
  ...
  static std::streampos seek(T &t, stream_offset off,
                             BOOST_IOS::seekdir way,
                             BOOST_IOS::openmode) { return t.seek(off, way); }
};
...
struct seek_filter_impl<two_head> {
  ...
  static std::streampos seek(T &t, Device &d,
                             stream_offset off,
                             BOOST_IOS::seekdir way,
                             BOOST_IOS::openmode which) { return t.seek(d, off, way, which); }
};
...
struct seek_filter_impl<any_tag> {
  ...
  static std::streampos seek(T &t, Device &d,
                             stream_offset off,
                             BOOST_IOS::seekdir way,
                             BOOST_IOS::openmode) { return t.seek(d, off, way); }
};
