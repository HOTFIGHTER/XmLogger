...
//
class BOOST_IOSTREAMS_DECL bzip2_error
...
BOOST_IOSTREAMS_PIPABLE(basic_bzip2_compressor,
1)
...
BOOST_IOSTREAMS_PIPABLE(basic_bzip2_decompressor,
1)
...
template<typename Alloc>
inline void bzip2_compressor_impl<Alloc>::init() { bzip2_base::init(true,
                                                                    static_cast<bzip2_allocator<
                                                                        Alloc> &>(*this));
}
...
template<typename Alloc>
inline void bzip2_decompressor_impl<Alloc>::init() { bzip2_base::init(false,
                                                                      static_cast<bzip2_allocator<
                                                                          Alloc> &>(*this));
}
} // End namespace detail.
