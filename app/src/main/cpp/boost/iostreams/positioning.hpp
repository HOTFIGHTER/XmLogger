...
stream_offset_to_streamoff(stream_offset off) { return static_cast<stream_offset>(off); }
...
inline stream_offset position_to_offset(PosType pos) { return std::streamoff(pos); }
