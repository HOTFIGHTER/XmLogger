...
static void tls_destructor(void *data) {
  ...
  mars_boost::detail::thread_data_ptr
      thread_info = static_cast<mars_boost::detail::thread_data_base *>(data)->shared_from_this();
...
static void *thread_proxy(void *param) {
  ...
  mars_boost::detail::thread_data_ptr
      thread_info = static_cast<mars_boost::detail::thread_data_base *>(param)->shared_from_this();
  thread_info->self.reset();
...
void BOOST_THREAD_DECL
sleep_for(const timespec &ts) {
  mars_boost::detail::thread_data_base
      *const thread_info = mars_boost::detail::get_current_thread_data();
...
void BOOST_THREAD_DECL
make_ready_at_thread_exit(shared_ptr<shared_state_base>
as) {
detail::thread_data_base *const current_thread_data(detail::get_current_thread_data());
if(current_thread_data) {
current_thread_data->
