...
#if !defined( UNDER_CE )
BOOST_SYMBOL_IMPORT mars_boost::detail::winapi::DWORD_
WINAPI GetCurrentThreadId(BOOST_DETAIL_WINAPI_VOID);
#endif
BOOST_SYMBOL_IMPORT mars_boost::detail::winapi::DWORD_
WINAPI
SleepEx(
...
WINAPI Sleep(mars_boost::detail::winapi::DWORD_ dwMilliseconds);
BOOST_SYMBOL_IMPORT mars_boost::detail::winapi::BOOL_
WINAPI SwitchToThread(BOOST_DETAIL_WINAPI_VOID);
}
#endif
