...
BOOST_INTRUSIVE_HAS_STATIC_MEMBER_FUNC_SIGNATURE(has_member_function_callable_with_pointer_to,
    pointer_to
)
BOOST_INTRUSIVE_HAS_STATIC_MEMBER_FUNC_SIGNATURE
(has_member_function_callable_with_dynamic_cast_from, dynamic_cast_from
)
BOOST_INTRUSIVE_HAS_STATIC_MEMBER_FUNC_SIGNATURE(has_member_function_callable_with_static_cast_from,
    static_cast_from
)
BOOST_INTRUSIVE_HAS_STATIC_MEMBER_FUNC_SIGNATURE(has_member_function_callable_with_const_cast_from,
    const_cast_from
)
#else
...
struct pointer_traits {
  ...
  ( mars_boost
  ::intrusive::detail::, Ptr, element_type
  , mars_boost::intrusive::detail::first_param<Ptr>)
  element_type;
  //
  typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT
  (mars_boost
  ::intrusive::detail::, Ptr, difference_type, std::ptrdiff_t)
  difference_type;

  typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT
  (mars_boost
  ::intrusive::detail::, Ptr, reference, typename mars_boost::intrusive::detail::unvoid_ref<
      element_type>::type)
  reference;
  //
  template<class U>
  ...
  static pointer static_cast_from(const UPtr &uptr) {
    ...
    return pointer_traits::priv_static_cast_from(mars_boost::intrusive::detail::bool_<value>(),
                                                 uptr);
  }
  ...
  static pointer const_cast_from(const UPtr &uptr) {
    ...
    (RefArg) > ::value
        ...
        has_member_function_callable_with_const_cast_from
            < pointer, pointer(*)(UPtr) > ::value;
    return pointer_traits::priv_const_cast_from(mars_boost::intrusive::detail::bool_<value>(),
                                                uptr);
  }
  ...
  static pointer dynamic_cast_from(const UPtr &uptr) {
    ...
    (RefArg) > ::value
        ...
        has_member_function_callable_with_dynamic_cast_from
            < pointer, pointer(*)(UPtr) > ::value;
    return pointer_traits::priv_dynamic_cast_from(mars_boost::intrusive::detail::bool_<value>(),
                                                  uptr);
  }
 ...
 private:
  //priv_to_raw_pointer
  template<class T>
  static T *to_raw_pointer(T *p) { return p; }

  template<class Pointer>
  static typename pointer_traits<Pointer>::element_type *
  to_raw_pointer(const Pointer &p) { return pointer_traits::to_raw_pointer(p.operator->()); }

  //priv_pointer_to
  static pointer
  priv_pointer_to(mars_boost::intrusive::detail::true_, reference r) { return Ptr::pointer_to(r); }

  static pointer priv_pointer_to(mars_boost::intrusive::detail::false_,
                                 reference r) {
  ...
  template<class UPtr>
  static pointer priv_static_cast_from(mars_boost::intrusive::detail::true_,
                                       const UPtr &uptr) { return Ptr::static_cast_from(uptr); }
  ...
  template<class UPtr>
  static pointer priv_const_cast_from(mars_boost::intrusive::detail::true_,
                                      const UPtr &uptr) { return Ptr::const_cast_from(uptr); }
  ...
  template<class UPtr>
  static pointer priv_dynamic_cast_from(mars_boost::intrusive::detail::true_,
                                        const UPtr &uptr) { return Ptr::dynamic_cast_from(uptr); }
...
struct pointer_traits<T *> {
  ...
  //!
  static pointer pointer_to(reference r) { return mars_boost::intrusive::detail::addressof(r); }

  //! <b>Returns</b>: static_cast<pointer>(uptr)
  //!
  template<class U>
  static pointer static_cast_from(U *uptr) { return static_cast<pointer>(uptr); }

  //! <b>Returns</b>: const_cast<pointer>(uptr)
  //!
  template<class U>
  static pointer const_cast_from(U *uptr) { return const_cast<pointer>(uptr); }

  //! <b>Returns</b>: dynamic_cast<pointer>(uptr)
  //!
  template<class U>
  static pointer dynamic_cast_from(U *uptr) { return dynamic_cast<pointer>(uptr); }
};
