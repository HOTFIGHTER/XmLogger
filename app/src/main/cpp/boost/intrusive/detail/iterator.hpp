...
struct iterator_enable_if_tag
    : ::mars_boost::move_detail::enable_if_c
          <::mars_boost::move_detail::is_same
               <typename mars_boost::intrusive::iterator_traits<I>::iterator_category, Tag
               >::value, R> {
};
...
struct iterator_enable_if_tag_difference_type
    : iterator_enable_if_tag<I,
                             Tag,
                             typename mars_boost::intrusive::iterator_traits<I>::difference_type> {
};

template<class I, class Tag>
struct iterator_disable_if_tag_difference_type
    : iterator_disable_if_tag<I,
                              Tag,
                              typename mars_boost::intrusive::iterator_traits<I>::difference_type> {
};
...
template<class I>
typename iterator_traits<I>::pointer iterator_arrow_result(const I &i) { return i.operator->(); }

template<class T>
T *iterator_arrow_result(T *p) { return p; }
