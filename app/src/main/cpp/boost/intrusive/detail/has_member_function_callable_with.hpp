...
struct BOOST_MOVE_CAT(has_member_function_callable_with_,
    BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME
)
{
template<class U>
static decltype(mars_boost::move_detail::declval<U>().
    BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME(::mars_boost::move_detail::declval<
    Args>()...)
    , mars_boost_intrusive_hmfcw::yes_type()) Test(U *f);
template<class U>
static mars_boost_intrusive_hmfcw::no_type Test(...);
static const bool
    value = sizeof(Test<Fun>((Fun *) 0)) == sizeof(mars_boost_intrusive_hmfcw::yes_type);
};
