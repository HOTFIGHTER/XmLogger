...
class reverse_iterator {
 public:
  ...
  reverse_iterator(const reverse_iterator<OtherIt> &r,
                   typename mars_boost::intrusive::detail::enable_if_convertible<OtherIt,
                                                                                 It>::type * = 0
  )
      : m_current(r.base()) {}
  ...
  It base() const { return m_current; }
  ...
  reference operator[](difference_type off) const { return this->m_current[-off - 1]; }
  ...
  friend reverse_iterator operator+(difference_type off, reverse_iterator r) { return (r += off); }
