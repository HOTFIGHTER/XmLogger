...
struct false_or_cpp11_noexcept_move_assignable<
    T,
    typename ::mars_boost::enable_if_c<sizeof(T) && BOOST_NOEXCEPT_EXPR(
        ::mars_boost::declval<T &>() = ::mars_boost::declval<T>())>::type
>: public ::mars_boost::integral_constant<bool,
                                          BOOST_NOEXCEPT_EXPR(::mars_boost::declval<T &>() =
                                                                  ::mars_boost::declval<T>())> {
};
...
struct is_nothrow_move_assignable: public integral_constant<bool,
                                                            ::mars_boost::detail::false_or_cpp11_noexcept_move_assignable<
                                                                T>::value> {
};

template<class T>
struct is_nothrow_move_assignable<T const>: public ::mars_boost::false_type {};
template<class T>
struct is_nothrow_move_assignable<T const volatile>: public ::mars_boost::false_type {};
template<class T>
struct is_nothrow_move_assignable<T volatile>: public ::mars_boost::false_type {};
template<class T>
struct is_nothrow_move_assignable<T &>: public ::mars_boost::false_type {};
