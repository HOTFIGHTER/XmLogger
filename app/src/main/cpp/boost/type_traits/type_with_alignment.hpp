...
struct long_double_alignment<Target, false> { typedef mars_boost::detail::max_align type; };

template<std::size_t Target, bool check>
struct double_alignment { typedef double type; };
template<std::size_t Target>
struct double_alignment<Target, false> {
  typedef typename long_double_alignment<Target,
                                         mars_boost::alignment_of<long double>::value
                                             >= Target>::type type;
};

#ifndef BOOST_NO_LONG_LONG
template<std::size_t Target, bool check>
struct long_long_alignment { typedef mars_boost::long_long_type type; };
template<std::size_t Target>
struct long_long_alignment<Target, false> {
  typedef typename double_alignment<Target,
                                    mars_boost::alignment_of<double>::value >= Target>::type type;
};
#endif
...
struct long_alignment<Target, false> {
  typedef typename long_long_alignment<Target,
                                       mars_boost::alignment_of<mars_boost::long_long_type>::value
                                           >= Target>::type type;
};
#else
...
struct int_alignment<Target, false> {
  typedef typename long_alignment<Target,
                                  mars_boost::alignment_of<long>::value >= Target>::type type;
};
...
struct short_alignment<Target, false> {
  typedef typename int_alignment<Target,
                                 mars_boost::alignment_of<int>::value >= Target>::type type;
};
...
struct char_alignment<Target, false> {
  typedef typename short_alignment<Target,
                                   mars_boost::alignment_of<short>::value >= Target>::type type;
};
...
struct type_with_alignment {
  typedef typename mars_boost::detail::char_alignment<Align,
                                                      mars_boost::alignment_of<char>::value
                                                          >= Align>::type type;
};
