...
struct common_pointee {
 ...
 public:
  ...
  typedef typename mars_boost::conditional<
      ...
      mars_boost::is_same<T2, U2>::value || mars_boost::is_void<T2>::value
          || mars_boost::is_base_of<T2, U2>::value,
...
struct composite_pointer_impl {
 ...
 public:
  ...
  typedef typename mars_boost::copy_cv<typename mars_boost::copy_cv<typename composite_pointer_type<
      T2,
      U2>::type const, T>::type, U>::type type;
};
