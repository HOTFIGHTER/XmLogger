...
struct ct_class {
  BOOST_STATIC_CONSTANT(bool,
                        ct = mars_boost::is_class<T>::value || mars_boost::is_union<T>::value);
  BOOST_STATIC_CONSTANT(bool,
                        cu = mars_boost::is_class<U>::value || mars_boost::is_union<U>::value);
...
template<class T, class U>
struct common_type_class: public mars_boost::conditional<
...
template<class T, class U>
struct common_type_impl: public mars_boost::conditional<
    ct_class<T, U>::value,
