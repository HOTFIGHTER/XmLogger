...
struct operator_returns_void {
  ...
  BOOST_STATIC_CONSTANT(bool,
                        value = (sizeof(::mars_boost::type_traits::yes_type)
...
struct operator_returns_Ret<Lhs, Rhs, Ret, false> {
  static ::mars_boost::type_traits::yes_type
  is_convertible_to_Ret(Ret); // this version is preferred for types convertible to Ret
  static ::mars_boost::type_traits::no_type
  is_convertible_to_Ret(...); // this version is used otherwise

  BOOST_STATIC_CONSTANT(bool, value = (sizeof(is_convertible_to_Ret(make<Lhs>()
      BOOST_TT_TRAIT_OP
      make<Rhs>()))==sizeof(::mars_boost::type_traits::yes_type)));
};
...
struct operator_exists {
  ...
  BOOST_STATIC_CONSTANT(bool, value = (sizeof(s_check(((make<Lhs>()
      BOOST_TT_TRAIT_OP
      make<Rhs>()), make<has_operator>())))==sizeof(::mars_boost::type_traits::yes_type)));
};
...
struct trait_impl1<Lhs, Rhs, Ret, false> {
  BOOST_STATIC_CONSTANT(bool,
                        value = (operator_exists<Lhs, Rhs>::value && operator_returns_Ret<Lhs,
                                                                                          Rhs,
                                                                                          Ret,
...
struct trait_impl {
  ...
  typedef typename ::mars_boost::remove_cv<typename ::mars_boost::remove_reference<typename ::mars_boost::remove_pointer<
      Lhs_noref>::type>::type>::type Lhs_noptr;
  typedef typename ::mars_boost::remove_cv<typename ::mars_boost::remove_reference<typename ::mars_boost::remove_pointer<
      Rhs_noref>::type>::type>::type Rhs_noptr;
  BOOST_STATIC_CONSTANT(bool,
                        value =
                            (trait_impl1<Lhs_noref, Rhs_noref, Ret, BOOST_TT_FORBIDDEN_IF>::value));
};
...
template<class Lhs, class Rhs=Lhs, class Ret=::mars_boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME,
                                                                              _impl)::dont_care>
struct BOOST_TT_TRAIT_NAME: public integral_constant<bool,
                                                     (::mars_boost::detail::BOOST_JOIN(
                                                         BOOST_TT_TRAIT_NAME,
                                                         _impl)::trait_impl<Lhs,
                                                                            Rhs,
                                                                            Ret>::value)> {
};
