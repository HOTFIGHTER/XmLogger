...
// 4.5/2
template<class T>
struct need_promotion: public mars_boost::is_enum<T> {};
...
struct integral_promotion { typedef T type; };
template<class T>
...
struct integral_promotion {
 ...
 public:
  typedef typename mars_boost::type_traits::detail::integral_promotion<T, tag_type::value>::type
      type;
};
