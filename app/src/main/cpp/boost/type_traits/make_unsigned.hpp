...
struct make_unsigned {
 private:
  BOOST_STATIC_ASSERT_MSG((::mars_boost::is_integral<T>::value || ::mars_boost::is_enum<T>::value),
                          "The template argument to make_unsigned must be an integer or enum type.");
  BOOST_STATIC_ASSERT_MSG((!::mars_boost::is_same<typename remove_cv<T>::type, bool>::value),
