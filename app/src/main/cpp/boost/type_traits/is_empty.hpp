...
struct is_empty_impl {
  ...
  BOOST_STATIC_CONSTANT(
      ...
      ::mars_boost::detail::empty_helper<
          cvt, ::mars_boost::is_class<T>::value, ::mars_boost::is_convertible<r_type, int>::value
...
template<class T>
struct is_empty: integral_constant<bool, ::mars_boost::detail::is_empty_impl<T>::value> {};
