...
template<class T>
struct common_type<T>: mars_boost::decay<T> {
};
...
struct common_type_impl: mars_boost::decay<decltype(mars_boost::declval<bool>()
                                                    ? mars_boost::declval<T1>()
                                                    : mars_boost::declval<T2>())> {
};
...
template<class T1, class T2, class T1d = typename mars_boost::decay<T1>::type, class T2d = typename mars_boost::decay<
    T2>::type>
struct common_type_decay_helper: mars_boost::common_type<T1d, T2d> {
};
