...
struct is_convertible_impl {
  BOOST_STATIC_CONSTANT(bool,
                        value = (::mars_boost::detail::is_convertible_basic_impl<From, To>::value
                            && !::mars_boost::is_array<To>::value
                            && !::mars_boost::is_function<To>::value));
};
#endif
...
struct is_convertible: public integral_constant<bool,
                                                ::mars_boost::detail::is_convertible_impl_dispatch<
                                                    From,
                                                    To>::value> {
};
