...
struct is_ununsigned_helper {
  BOOST_STATIC_CONSTANT(bool,
                        value = (::mars_boost::detail::is_unsigned_values<T>::minus_one
                            > ::mars_boost::detail::is_unsigned_values<T>::zero));
};
...
template<class T>
struct is_unsigned {
  typedef ::mars_boost::detail::is_unsigned_select_helper<
      ::mars_boost::is_integral<T>::value || ::mars_boost::is_enum<T>::value> selector;
...
template<class T>
struct is_unsigned: public integral_constant<bool, mars_boost::detail::is_unsigned<T>::value> {};
...
template<>
struct is_unsigned<::mars_boost::ulong_long_type>: public true_type {};
template<>
struct is_unsigned<const ::mars_boost::ulong_long_type>: public true_type {};
template<>
struct is_unsigned<volatile ::mars_boost::ulong_long_type>: public true_type {};
template<>
struct is_unsigned<const volatile ::mars_boost::ulong_long_type>: public true_type {};

template<>
struct is_unsigned<::mars_boost::long_long_type>: public false_type {};
template<>
struct is_unsigned<const ::mars_boost::long_long_type>: public false_type {};
template<>
struct is_unsigned<volatile ::mars_boost::long_long_type>: public false_type {};
template<>
struct is_unsigned<const volatile ::mars_boost::long_long_type>: public false_type {};
#endif
#if defined(CHAR_MIN)
#if CHAR_MIN == 0
template<>
