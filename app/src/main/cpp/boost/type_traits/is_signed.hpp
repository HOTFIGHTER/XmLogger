...
struct is_signed_helper {
  ...
  BOOST_STATIC_CONSTANT(bool,
                        value = (!(::mars_boost::detail::is_signed_values<T>::minus_one
                            > mars_boost::detail::is_signed_values<T>::zero)));
};
...
struct is_signed_impl {
  typedef ::mars_boost::detail::is_signed_select_helper<
...
template<class T>
struct is_signed: public integral_constant<bool, mars_boost::detail::is_signed_impl<T>::value> {};
...
template<>
struct is_signed<::mars_boost::long_long_type>: public true_type {};
template<>
struct is_signed<const ::mars_boost::long_long_type>: public true_type {};
template<>
struct is_signed<volatile ::mars_boost::long_long_type>: public true_type {};
template<>
struct is_signed<const volatile ::mars_boost::long_long_type>: public true_type {};

template<>
struct is_signed<::mars_boost::ulong_long_type>: public false_type {};
template<>
struct is_signed<const ::mars_boost::ulong_long_type>: public false_type {};
template<>
struct is_signed<volatile ::mars_boost::ulong_long_type>: public false_type {};
template<>
struct is_signed<const volatile ::mars_boost::ulong_long_type>: public false_type {};
#endif
#if defined(CHAR_MIN)
#if CHAR_MIN != 0
