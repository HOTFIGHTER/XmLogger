...
struct drop_front {
  ...
  struct apply {
    typedef BOOST_DEDUCED_TYPENAME drop_front
    <N-1>
    ::BOOST_NESTED_TEMPLATE
        apply<Tuple>
    next;
    typedef BOOST_DEDUCED_TYPENAME next
    ::type::tail_type type;
...
struct element {
  ...
  ::drop_front<N>::BOOST_NESTED_TEMPLATE
...
struct element<N, const T> {
 ...
 public:
  ...
  ::add_const<unqualified_type>::type type;
#endif
};
...
get(cons<HT, TT> &c) {
  ...
  typedef BOOST_DEDUCED_TYPENAME impl
  ::type cons_element;
