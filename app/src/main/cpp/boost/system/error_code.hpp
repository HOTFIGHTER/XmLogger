...
template<>
struct is_error_condition_enum<errc::errc_t> { static const bool value = true; };
...
class error_condition {
 public:
  ...
  typename mars_boost::enable_if<is_error_condition_enum<ErrorConditionEnum>,
